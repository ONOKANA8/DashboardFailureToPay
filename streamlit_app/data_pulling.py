...
class PlotterModule:
    ...
    def __init__(self):
        ...
        self.path_to_data = "streamlit_data_source/fichier-test1000-api.csv"
        self.path_to_model = "lgbm_beta_3_Model_.joblib"
        self.model = joblib.load(self.path_to_model)
        self.data = pd.read_csv(self.path_to_data).drop('Unnamed: 0', axis=1)
        self.path_to_logo = "streamlit_data_source/logo_pret_a_depenser.png"
