...
class StreamlitWebpagePlotter:
    ...
    def gauge(self, ID: int, class_cat, val_score):
        """
    ...
    def local_interpret(self, ID: int):
        """
    ...
    def interactive_hist_plot(self, ID: int, dt):
        """
    ...
    def interactive_scatter_plot(self, ID: int, dt, val_score):
        """
